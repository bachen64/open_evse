// table from C:\Users\Geek\.platformio\packages\framework-arduino-samd\variants\arduino_zero\variant.cpp
#pragma once
/*
 * +------------+------------------+--------+-----------------+--------------------------------------------------------------------------------------------------------
...
/*
#defines generated by https://grok.com/c/bc3507b4-0f4c-4ff1-81ea-448429308146?rid=118354ef-aedc-4fb8-8796-072878f2a395

Notes:

Only pins that have a clear Pin Number (0–45 range in the left column) are included.
Pins without an explicit Arduino pin number (e.g. pure USB pins without number, crystal pins PA00/PA01, some EDBG-only entries without number) were skipped.
Some pins appear multiple times (e.g. PA22 = 20 and 32) because they are shared (SDA / EDBG_SDA). You can choose whether to keep only one or use both depending on your coding style.
The generated names follow the common pattern seen in many Arduino SAMD variants (e.g. #define ZERO_PAxx N).
*/

// n.b. we don't use XXXX because they're already defined differently in 
// C:\Users\Geek\.platformio\packages\framework-cmsis-atmel\CMSIS\Device\ATMEL\samd21\include\pio\samd21g18a.h
#define ZERO_PA11  0
#define ZERO_PA10  1
#define ZERO_PA14  2
#define ZERO_PA09  3
...
#define ZERO_PA02 14   // A0
#define ZERO_PB08 15   // A1
#define ZERO_PB09 16   // A2
#define ZERO_PA04 17   // A3
#define ZERO_PA05 18   // A4
#define ZERO_PB02 19   // A5

#define ZERO_PA22 20   // SDA
#define ZERO_PA23 21   // SCL

#define ZERO_PA12 22   // MISO (legacy ICSP)
#define ZERO_PB10 23   // MOSI
#define ZERO_PB11 24   // SCK

#define ZERO_PB03 25   // RX LED related
#define ZERO_PA27 26   // TX LED related

#define ZERO_PA28 27   // USB_HOST_ENABLE

#define ZERO_PA24 28   // USB/DM
#define ZERO_PA25 29   // USB/DP

// EDBG related (internal)
#define ZERO_PB22 30   // EDBG_UART TX
#define ZERO_PB23 31   // EDBG_UART RX

// EDBG alternate mappings (often same physical pins)
//#define ZERO_PA22 32   // EDBG_SDA  (same as 20)
//#define ZERO_PA23 33   // EDBG_SCL  (same as 21)
//#define ZERO_PA19 34   // EDBG_MISO (same as 12)
//#define ZERO_PA16 35   // EDBG_MOSI (same as 11)
//#define ZERO_PA18 36   // EDBG_SS   (same as 10)
//#define ZERO_PA17 37   // EDBG_SCK  (same as 13)

#define ZERO_PA13 38   // ATN / EDBG_GPIO0

// Additional / special pins
#define ZERO_PA03 42   // AREF
#define ZERO_PA30 44   // SWCLK
#define ZERO_PA31 45   // SWDIO
